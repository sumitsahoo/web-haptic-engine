...
var MutableReactiveHandler = class extends BaseReactiveHandler {
  ...
  set(target, key, value, receiver) {
    ...
    if (!this._isShallow) {
      ...
      if (
        !isArrayWithIntegerKey &&
        /* @__PURE__ */ isRef(oldValue) &&
        !(/* @__PURE__ */ isRef(value))
      )
    ...
    readonly
      ...
      : {
          add(value) {
            ...
            const valueToAdd =
              !shallow &&
              !(/* @__PURE__ */ isShallow(value)) &&
              !(/* @__PURE__ */ isReadonly(value))
                ? rawValue
                : value;
            if (
              !(
...
var RefImpl = class {
  ...
  set value(newValue) {
    ...
    const useDirectValue =
      this["__v_isShallow"] ||
      /* @__PURE__ */ isShallow(newValue) ||
      /* @__PURE__ */ isReadonly(newValue);
...
function watch$1(source, cb, options = EMPTY_OBJ) {
  ...
  if (/* @__PURE__ */ isRef(source)) {
    ...
    forceTrigger = source.some(
      (s) => /* @__PURE__ */ isReactive(s) || /* @__PURE__ */ isShallow(s),
    );
    getter = () =>
      source.map((s) => {
    ...
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render.call(
          ...
          proxyToUse,
          renderCache,
          /* @__PURE__ */ shallowReadonly(props),
          setupState,
          data,
          ctx,
        ),
...
//# sourceMappingURL=vue.runtime.esm-bundler-Bs9juSvY.js.map

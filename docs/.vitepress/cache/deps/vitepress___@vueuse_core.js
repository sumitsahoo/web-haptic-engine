...
function reactiveOmit(obj, ...keys) {
  ...
  return reactiveComputed(() =>
    typeof predicate === "function"
      ? Object.fromEntries(
          Object.entries(toRefs$1(obj)).filter(([k, v]) => !predicate(toValue(v), k)),
        )
...
function useClipboard(options = {}) {
  ...
  const isClipboardApiSupported = /* @__PURE__ */ useSupported(
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload))
          watch([refetch, toRef(config.payload)], ([refetch$1]) => refetch$1 && execute(), {
            deep: true,
          });
        return {
          ...shell,
